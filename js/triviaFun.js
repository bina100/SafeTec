function addSingleQuestion(_question, _answers_ar, _correctAnswer) {
    ...
    answersDiv.className = "answers py-2 row";
    ...
    _answers_ar.forEach(function (answeItem, i) {
        ...
        btn.className = "col-md-5 my-2 mx-md-auto"
        btn.addEventListener("click", function () {

            if (i == _correctAnswer) {
                setTimeout(() => { successAnswer() }, 700)
                btn.style.background = "green";
                document.querySelector(".h5").innerHTML = `תשובה נכונה`
                ...
                document.querySelector(".h5").innerHTML = `תשובה שגויה`
